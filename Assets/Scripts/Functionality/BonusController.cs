...
public class BonusController : MonoBehaviour
{
    ...
    private IEnumerator PopupRoutine()
    {
        ...
        if (Title_text) Title_text.DOFade(1f, 1f);
        yield return new WaitForSeconds(1.5f);
        if (BonusTitle_text) BonusTitle_text.DOFade(1f, 1f);
        yield return new WaitForSeconds(1.5f);
        if (BonusVal_text) BonusVal_text.DOFade(1f, 1f);
        yield return new WaitForSeconds(1.5f);
        if (Multi_text) Multi_text.DOFade(1f, 1f);
        yield return new WaitForSeconds(1.5f);
        if (MultiVal_text) MultiVal_text.DOFade(1f, 1f);
        yield return new WaitForSeconds(1.5f);
        if (TotalWIn_text) TotalWIn_text.DOFade(1f, 1f);
